...
description: "En avskalad portfolio med fokus på att vara lätt att läsa, navigera, ge god prestanda och vara utbyggbar med nya projekt på ett enkelt och strukturerat sätt."
...
- Astro API - Server render
- Svelte - Enskild interaktiva komponent för formulärhantering
- Tailwind CSS - Styling
- Resend - Hantering av e-post

## Lärdom

Min portfoliosida har ökat mina kunskaper i Astro genom att kombinera för mig nya tekniker med tekniker jag använt i tidigare projekt. Den har också get mig en grund i att ha en utility based styling genom att använda Tailwind css.
